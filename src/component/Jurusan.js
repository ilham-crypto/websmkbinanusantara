                        ...
                        <Mui.Grid container spacing={1}>
                            <Mui.Grid item xs={12} sm={6}>
                                <h3 align="center">TBSM</h3>
                                    ...
                                    <Mui.Container spacing={1}>
                                    <Mui.Grid item xs={12} sm={6}>
                                    <img src="22.jpg" width="200" height="200"/>
                                    <img src="33.jpg" width="200" height="200"/>
                                    </Mui.Grid>
                                    </Mui.Container>
                            </Mui.Grid>
                            <Mui.Grid item xs={12} sm={6}>
                        ...
                        <Mui.Grid container spacing={1}>
                            <Mui.Grid item xs={12} sm={6}>
                                <h3 align="center">TKJ</h3>
                                    <p>Teknik komputer dan jaringan adalah kompetensi keahlian yg mempelajari tentang teknologi informasi dan jaringan. Di smk bina nusantara lulusannya mampu menjadi network engineer,software development dan juga bisa membuat film animasi .
                        ...
                        <Mui.Grid container spacing={1}>
                            <Mui.Grid item xs={12} sm={6}>
                                <h3 align="center">TATA BUSANA</h3>
                                    ...
                                    <img src="99.jpg" width="200" height="200"/>
                                    </Mui.Grid>
                                    </Mui.Container>
                            </Mui.Grid>
                            <Mui.Grid item xs={12} sm={6}>
